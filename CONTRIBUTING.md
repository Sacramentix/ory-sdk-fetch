...
# Contribute to Ory Ory SDK<!-- omit in toc -->
...
- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/sdk/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory Ory SDK?](#communication)
...
[list of good first issues](https://github.com/ory/sdk/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory Ory SDK.
...
- **Help with open issues.** We have a lot of open issues for Ory Ory SDK and
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [list of prefixes for Ory SDK](https://github.com/ory/sdk/blob/master/.github/semantic.yml)
   for an overview.
...
[Contributor License Agreement](https://cla-assistant.io/ory/sdk).
...
git clone git@github.com:ory/ory/sdk.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/sdk.git
