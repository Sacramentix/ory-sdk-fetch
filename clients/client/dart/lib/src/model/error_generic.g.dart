...
class _$ErrorGeneric extends ErrorGeneric {
  @override
  final GenericErrorContent error;
...
class ErrorGenericBuilder
  ...
  GenericErrorContentBuilder? _error;
  GenericErrorContentBuilder get error =>
      _$this._error ??= new GenericErrorContentBuilder();
  set error(GenericErrorContentBuilder? error) => _$this._error = error;
