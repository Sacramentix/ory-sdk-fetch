...
class JwkApi {
  ...
  const JwkApi(this._dio, this._serializers);
  ...
  Future<Response<JsonWebKeySet>> createJsonWebKeySet({ 
    ...
    try {
      const _type = FullType(CreateJsonWebKeySet);
