...
export class CourierApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async listCourierMessages(pageSize?: number, pageToken?: string, status?: CourierMessageStatus, recipient?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
